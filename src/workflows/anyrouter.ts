...
export interface AnyRouterParams {
  sourceId: string;
  scheduledTime: number;
}

export class AnyRouterWorkflow extends WorkflowEntrypoint<Env, AnyRouterParams> {
  override async run(event: WorkflowEvent<AnyRouterParams>, step: WorkflowStep): Promise<void> {
