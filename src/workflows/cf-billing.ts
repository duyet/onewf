...
export interface CfBillingParams {
  sourceId: string;
  scheduledTime: number;
}

export class CfBillingWorkflow extends WorkflowEntrypoint<Env, CfBillingParams> {
  override async run(event: WorkflowEvent<CfBillingParams>, step: WorkflowStep): Promise<void> {
